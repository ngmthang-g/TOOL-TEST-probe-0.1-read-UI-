...
- Version: `0.1.4-probe`.
- Build: **BUILD PASS** trên Windows/MSVC x64 — run `34669951178` đã PASS source-contract, configure, Release build, native CTest, package, artifact upload và publish `dist/`.
